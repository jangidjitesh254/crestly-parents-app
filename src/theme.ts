/**
 * Crestly Parents — React Native theme.
 *
...
/** Fee/payment status → colour pairing. */
export const paymentStatusColor: Record<string, { bg: string; fg: string }> = {
  paid: { bg: tint.mint.base, fg: tint.mint.deep },
  partial: { bg: semantic.warn.soft, fg: semantic.warn.base },
  pending: { bg: tint.wheat.base, fg: tint.wheat.deep },
  overdue: { bg: semantic.error.soft, fg: semantic.error.base },
};
